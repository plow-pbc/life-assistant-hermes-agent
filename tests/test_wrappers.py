...
(1=alert, 2=affirmation, 3=weather, 5=sports, 6=priorities). On
...
morning-triage (the Mac's iMessage DB through Latch), the two calendar
producers (morning-updates, calendar-nudge) on Latch's vendored
