...
run directly (a retry after a failed send), this wrapper is that same `post`,
so title and tile are recomposed from one manifest snapshot.
"""
import os
import sys
...
if __name__ == "__main__":
    ...
    priorities.main(["post", *sys.argv[1:]])
