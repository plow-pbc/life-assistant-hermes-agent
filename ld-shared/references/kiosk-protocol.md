...
| 4 | `digest` | *(none — the weekly digest was retired; the slot stays in the viewer)* | plain text, long-form (viewer-clamped) |
...
## Plain-text cards (1, 2)

For cards 1 and 2, `text` is a short paraphrased line, **≤115 chars** to match
the kiosk's visible budget. On every plain-text card, producers
